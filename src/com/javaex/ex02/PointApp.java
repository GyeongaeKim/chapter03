...
public class PointApp {
	...
	public static void main(String[] args) {
		...
		//인스턴스(객체)의 정보 보기 ---> Point의 toString() 재정의 전후 비교
		System.out.println(p01.toString());
		System.out.println(p02.toString());
		System.out.println("---------------------------------------------");
				
		//hashCode - 메모리 주소값에 대응되는 중복되지 않는 숫자
		...
		// ==변수의 값이 같나?
		// 기본자료형은 실제 값이 같냐?
		// 기본자료형 이외에 값은 다 주소! ---> 주소가 같나?
		System.out.println(p00==p01);
		System.out.println(p00==p02);
		System.out.println(p01==p02);
		System.out.println(p02==p03); // true --> p03 = p02 이기 때문에(주소가 같기 때문에)
		System.out.println();
